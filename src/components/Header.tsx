...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white py-1 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 relative">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-1 sm:space-y-0 sm:space-x-2 lg:space-x-6 text-center">
            <div className="flex items-center space-x-1 bg-white/20 rounded-full px-2 lg:px-3 py-0.5">
            ...
            <div className="hidden sm:flex items-center space-x-2 lg:space-x-4 text-xs font-bold">
      ...
      <div className="bg-white/95 backdrop-blur-xl border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-2 sm:px-4">
          <div className="flex justify-between items-center py-1">
            ...
            <Link to="/" className="flex items-center hover-lift-intense">
            ...
            <div className="hidden xl:flex items-center space-x-3 lg:space-x-4">
              <nav className="flex items-center space-x-3 lg:space-x-4">
                <a href="#comparador" className="font-bold text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-105 relative group text-xs lg:text-sm">
                  Comparador IA
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#testimonios" className="font-bold text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-105 relative group text-xs lg:text-sm">
                  Testimonios
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <Link to="/sobre-nosotros" className="font-bold text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-105 relative group text-xs lg:text-sm">
                  Sobre Nosotros
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </Link>
                <Link to="/contacto" className="font-bold text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-105 relative group text-xs lg:text-sm">
                  Contacto
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </nav>
              ...
              <div className="flex items-center space-x-1 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 px-2 py-1 rounded-lg hover-lift-intense shine-effect">
              ...
              <a href="#formulario" className="btn-primary text-white px-2 lg:px-3 py-1 rounded-lg font-black text-xs hover-lift-intense shine-effect whitespace-nowrap">
                EMPEZAR FORMULARIO
              </a>
            </div>
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-t border-blue-100 shadow-blue-intense animate-fade-in-up">
          <div className="px-4 py-4 space-y-4">
            ...
            <div className="pt-4 border-t border-blue-200">
              <div className="flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl py-3 mb-4 shadow-blue-glow">
              ...
              <a 
                href="#formulario" 
                onClick={() => setIsMobileMenuOpen(false)}
                className="block w-full btn-primary text-white py-3 rounded-xl font-black text-lg text-center shine-effect"
              >
                🚀 EMPEZAR FORMULARIO
              </a>
            </div>
